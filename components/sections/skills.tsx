        ...
        <section id={id} className="py-24 bg-background overflow-hidden">
            <div className="container mx-auto px-6">
                ...
                >
                    ...
                    <h1 className="text-4xl font-bold md:text-5xl">Technical Arsenal</h1>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {skills.map((skill, index) => (
                        <motion.div
                            ...
                            className="group p-8 rounded-2xl bg-accent/5 border border-accent/10 hover:border-accent/40 transition-all duration-300"
                        >
